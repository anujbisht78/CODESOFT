...
def data_get():
    ...
    per_label1.config(text=data["main"]["humidity"])
...
name_label=Label(win,text="Weather Info",font=("Time New Roman",30,"bold"))
...
com=ttk.Combobox(win,text="Weather Info",values=list_name,font=("Time New Roman",20,"bold"),textvariable=city_name)
...
temp_label=Label(win,text="Weather Temperature",font=("Time New Roman",15))
temp_label.place(x=25,y=400,height=50,width=210)
temp_label1=Label(win,text="",font=("Time New Roman",15))
temp_label1.place(x=250,y=400,height=50,width=210)

per_label=Label(win,text="Humidity",font=("Time New Roman",15))
